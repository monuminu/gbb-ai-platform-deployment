...
export function RHFUploadAvatar({ name, rectangular, ...other }: Props) {
  ...
  return (
    <Controller
      ...
      render={({ field, fieldState: { error } }) => (
        <div>
          {rectangular && (
            <UploadAvatarRectangular error={!!error} file={field.value} {...other} />
          )}

          {!rectangular && <UploadAvatar error={!!error} file={field.value} {...other} />}

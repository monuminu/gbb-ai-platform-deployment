...
const StyledMarkdown = styled('div')(({ theme }) => {
  ...
  return {
    // Text
    h1: { margin: theme.spacing(1, 0), lineHeight: 1.5, ...theme.typography.h1 },
    h2: { margin: theme.spacing(1, 0), lineHeight: 1.5, ...theme.typography.h2 },
    h3: { margin: theme.spacing(1, 0), lineHeight: 1.5, ...theme.typography.h3 },
    h4: { margin: theme.spacing(1, 0), lineHeight: 1.5, ...theme.typography.h4 },

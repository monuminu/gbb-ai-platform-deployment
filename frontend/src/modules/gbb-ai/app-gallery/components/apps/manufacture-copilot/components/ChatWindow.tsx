...
import { onComposeRequest } from 'src/api/gpt';
import { callManufacturingCopilot } from 'src/api/app-gallery';
...
export default function ChatWindow({
  ...
  const selectedToolDefinitions = tools
    .filter((tool) => selectedTools.includes(tool.id) && tool.meta.trim() !== '')
